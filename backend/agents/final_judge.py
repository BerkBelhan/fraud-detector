...
Your verdict can be "Safe", "Suspicious", or "Likely Scam".
Base your decision on the following analyses:
If your overall score is between 0-24, the verdict is "Likely Scam".
If your overall score is between 25-50, the verdict is "Suspicious".
If your overall score is between 51-75, the verdict is "Likely Safe".
If your overall score is between 76-100, the verdict is "Very Safe".
Your output MUST be a single JSON object that strictly adheres to this schema:
{{
    "summary": "A brief summary of your analysis.",
    "verdict": "Likely Scam", "Suspicious", "Likely Safe", "Very Safe",
